...
extern void bridge_task_function (void * pvParameter);
...
int main(void)
{
  ...
  LEDS_ON(BSP_LED_0_MASK | BSP_LED_1_MASK | BSP_LED_2_MASK );
    ...
    UNUSED_VARIABLE(xTaskCreate(bridge_task_function, "SSTWR_INIT", configMINIMAL_STACK_SIZE + 200, NULL, 2, &ss_initiator_task_handle));
  #endif // #ifdef USE_FREERTOS
